...
// ─── TransitionPopup ───────────────────────────────────────────────────────────
// Shown before each game round to announce the word-length target.
...
const TransitionPopup = ({ dark, step, wordLen, onGo }) => (
  ...
  >
    ...
    >
      ...
      >
        Form as many {wordLen}-letter words as possible before the timer ends!
      </p>

      <motion.button
        whileHover={{ scale: 1.06, boxShadow: "0 0 24px rgba(16,185,129,0.5)" }}
        whileTap={{ scale: 0.95 }}
        onClick={onGo}
        className="w-full py-2 rounded-xl font-black text-white text-xl
